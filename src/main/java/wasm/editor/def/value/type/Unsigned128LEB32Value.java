 ...
 */
public class Unsigned128LEB32Value extends ValueTypeAble<BigInteger> {
    ...
    public static Unsigned128LEB32Value createSimple(int value) {
        return (Unsigned128LEB32Value) new Unsigned128LEB32Value().set(BigInteger.valueOf(value));
    }

    public static int getSimpleInt(TypeAble value) {
        return ((Unsigned128LEB32Value) value).get().intValue();
    }
}
